      ...
      <div class="translations-content-container">
        <div class="container">
          ...
          >
            ...
            <p className="pt-4">Last updated: June 16, 2023</p>
            <p>
            ...
            <h1 className="pt-4">Interpretation and Definitions</h1>
            ...
            <h2 className="pt-4">Definitions</h2>
            <p className="pt-4">For the purposes of this Privacy Policy:</p>
            <ul>
              <li>
                <p>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to DIGITOONZ MEDIA
                  &amp; ENTERTAINMENT PRIVATE, C29 Sector 6.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to Flinko, accessible from{" "}
                  <a
                    href="https://www.flinko.app/"
                    rel="external nofollow noopener noreferrer"
                    target="_blank"
                  >
                    https://www.flinko.app/
                  </a>
                </p>
              </li>
              <li>
            ...
            <h1 className="pt-4">Collecting and Using Your Personal Data</h1>
            <h2 className="pt-4">Types of Data Collected</h2>
            <h3 className="pt-4">Personal Data</h3>
            <p>
            ...
            <h3 className="pt-4">Usage Data</h3>
            <p className="pt-4">
            ...
            <h3 className="pt-4">Tracking Technologies and Cookies</h3>
            <p className="pt-4">
            ...
            <h2 className="pt-4">Use of Your Personal Data</h2>
            <p className="pt-4">
            ...
            <h2 className="pt-4">Retention of Your Personal Data</h2>
            <p className="pt-4">
            ...
            <h2 className="pt-4">Transfer of Your Personal Data</h2>
            <p className="pt-4">
            ...
            <h2 className="pt-4">Delete Your Personal Data</h2>
            <p className="pt-4">
            ...
            <h2 className="pt-4">Disclosure of Your Personal Data</h2>
            <h3 className="pt-4">Business Transactions</h3>
            <p className="pt-4">
            ...
            <h3 className="pt-4">Law enforcement</h3>
            <p className="pt-4">
            ...
            <h3 className="pt-4">Other legal requirements</h3>
            <p className="pt-4">
            ...
            <h2 className="pt-4">Security of Your Personal Data</h2>
            <p className="pt-4">
            ...
            <h1 className="pt-4">Children's Privacy</h1>
            <p className="pt-4">
            ...
            <h1 className="pt-4">Changes to this Privacy Policy</h1>
            <p className="pt-4">
            ...
            <ul>
              <li>By email: flinko.app@gmail.com</li>
            </ul>
          </div>
        </div>
      </div>
